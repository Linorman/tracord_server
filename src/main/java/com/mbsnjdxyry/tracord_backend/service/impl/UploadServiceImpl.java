...
import com.mbsnjdxyry.tracord_backend.utils.ImgUtils;
import com.mbsnjdxyry.tracord_backend.utils.OssUtils;
...
import static com.mbsnjdxyry.tracord_backend.common.ResultCode.UPLOAD_SUCCESS;
...
//        1.获取到原始文件名
        ...
        return ResponseResult.success(UPLOAD_SUCCESS,imgUrl);
    }
    ...
    private String ossUpload(MultipartFile multipartFile, String fileName) {
        ...
        String objectName = "nju/" + fileName;
        try {
